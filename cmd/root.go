...
func init() {
	...
	// RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-multi-command.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".go-multi-command" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".go-multi-command")
	}
